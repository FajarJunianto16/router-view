        ...
        <section class="page-section" id="services">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Fajar Junianto lahir di Jakarta pada tanggal 16 Juni 2003, Suka pada bidang astronomi,<br> kadang suka menonton dan melakukan beberapa sulap, <br> dan juga sedang belajar programming walau tidak terlalu jago.</h3>
                </div>
                <div class="row text-center">
                    <div class="col-md-12">
                        ...
                        <h4 class="my-3">Fajar Junianto</h4>
                        <p class="text-muted">Student | Programmer | Magician</p>
                    </div>
                </div>
            </div>
        </section>
